    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                <!--begin::Toggle-->
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1" data-toggle="tooltip" title="El idioma actual es español" data-placement="bottom">
                        <img class="h-20px w-20px rounded-sm" src="{{ asset('metronic/assets/media/svg/flags/021-mexico.svg') }}" alt="" />
                    </div>
                </div>
                <!--end::Toggle-->
                <!--begin::Dropdown-->
                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi navi-hover py-4">
                        <!--begin::Item-->
                        <li class="navi-item">
                            <a href="#" class="navi-link" data-toggle="tooltip" title="El idioma actual es español" data-placement="left">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="{{ asset('metronic/assets/media/svg/flags/021-mexico.svg') }}" alt="" />
                                </span>
